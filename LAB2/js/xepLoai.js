...
function getInfo() {
  ...
  if (stringContainsNumber(hoTen)) {
    ...
    if (isNaN(diemTb) == true) {
      ...
      document.getElementById("OutputHoTen").innerHTML =
        "Họ và Tên: " + hoTen.toUpperCase();
      document.getElementById("OutputDiemTb").innerHTML =
        "Điểm trung bình: " + diemTb;
      document.getElementById("OutputXepLoai").innerHTML =
        "Đánh giá: " + xepLoai(diemTb);
    }
  }
}
